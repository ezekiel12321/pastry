...
public class ResponseMessage extends ScribeMessage{
    ...
    public ResponseMessage(NodeHandle source, Topic topic, ScribeContent content) {
    ...
    public ResponseMessage(NodeHandle source, Topic topic, RawScribeContent content) {
	    super(source, topic);
    ...
    public static ResponseMessage build(InputBuffer buf, Endpoint endpoint, ScribeContentDeserializer scd) throws IOException {
	    byte version = buf.readByte();
	    switch(version) {
	      case 0:
	        return new ResponseMessage(buf, endpoint, scd);
	      default:
     ...
     * version number.
     */
    private ResponseMessage(InputBuffer buf, Endpoint endpoint, ScribeContentDeserializer cd) throws IOException {
        super(buf, endpoint);
